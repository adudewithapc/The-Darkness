...
public class ModelHuman extends ModelBase
{
    ...
    public ModelHuman.ArmPose leftArmPose;
    public ModelHuman.ArmPose rightArmPose;
    ...
    public ModelHuman(float modelSize)
    {
        this(modelSize, 0.0F, 64, 64);
    }

    public ModelHuman(float modelSize, float p_i1149_2_, int textureWidthIn, int textureHeightIn)
    {
        this.leftArmPose = ModelHuman.ArmPose.EMPTY;
        this.rightArmPose = ModelHuman.ArmPose.EMPTY;
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (this.rightArmPose == ModelHuman.ArmPose.BOW_AND_ARROW)
        {
        ...
        else if (this.leftArmPose == ModelHuman.ArmPose.BOW_AND_ARROW)
        {
    ...
    public void setModelAttributes(ModelBase model)
    {
        ...
        if (model instanceof ModelHuman)
        {
            ModelHuman modelbiped = (ModelHuman)model;
